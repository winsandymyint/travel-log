...
$str="SELECT v.VisitDate,v.Location,v.Formalname,v.Formaladdress,v.Longitude,v.Latitude,v.Locationimage,v.Comment,v.Hotelimg,v.Restaurantimg,c.Country,c.Countryimg1,ci.City,ci.Cityimg1,Cityimg2,Cityimg3,r.Region,r.Regionimg1,r.Regionimg2
		...
		WHERE v.Countryid=c.Countryid and v.Regionid=r.Regionid and v.cityid=ci.Cityid and v.Regionid=$regionid";
...
while($row=mysql_fetch_array($res))
{
	...
	echo ' <div align="center" class="visit1">
	          <h1 align="center">'.$row["Region"].'  &amp; '.$row["Country"].'  Image</h1>
                ...
                <p>
                 ...
                 <p>
                     <h1 align="center">'.$row["City"].'</h1>
                    <img src="'.$row["Regionimg2"].'" class="visitimg"/>
                    <img src="'.$row["Cityimg2"].'" class="visitimg"/>
                    <img src="'.$row["Cityimg3"].'" class="visitimg"/>
                </p>
                <p>
