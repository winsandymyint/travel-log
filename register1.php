                        ...
                        <table> 
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td> <input type="date" name="date" id="date" class="form-control s1"/></td>
                            </tr>
                             <tr>
                                <td><label  class="lbl">IsNewsLetter</label></td>
                                <td> 
                                <input type="radio" name="letter" value="1" id="y"/><label for="y" class="font">Yes</label>
                                <input type="radio" name="letter" value="0"  id="n"/><label for="n" class="font">No</label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"><input type="submit" value="Register" class="btn"/></p></td>
