                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {   $vid= $row["Visitid"];
                                                ...
                                                echo  "<td><a href='allInsert.php?insert_id=visit&type=edit&id=$vid' class='btn btn-sm btn-color' role='button'>Edit</a>&nbsp;<a href='delete.php?type=delete&id=$vid' class='btn btn-sm btn-color' role='button'>Delete</a></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                        </tbody>
